...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("desk_tip", "Please send the following ID and password to Raresoft technical support."),
        ("connecting_status", "Connecting to the RaresoftSupport network..."),
        ...
        ("install_tip", "Due to UAC, RaresoftSupport can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install RaresoftSupport to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant RaresoftSupport \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant RaresoftSupport \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow RaresoftSupport to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [RaresoftSupport Input] service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next RaresoftSupport application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant RaresoftSupport \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant RaresoftSupport \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running RaresoftSupport."),
        ...
        ("verify_rustdesk_password_tip", "Verify RaresoftSupport password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use RaresoftSupport and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Please upgrade RaresoftSupport Server Pro to version {} or newer!"),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent RaresoftSupport from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by Raresoft"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if RaresoftSupport window is open"),
        ...
        ("floating_window_tip", "It helps to keep RaresoftSupport background service"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Please upgrade the RaresoftSupport client to version {} or newer on the remote side!"),
